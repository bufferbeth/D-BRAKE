...
#define STOP_BRAKESETUPEXTEND 0x4E20  //20000 - CHANGE BACK TO 1 FOR NORMAL BUILDS
 
uint8_t brakeState;
uint8_t brakeChange;

#define BRAKESUPTIME 10
#define BRAKESUPTIME_SHORT 2
...
//-01_14limit---------- below removed to allow limit to be hit 
